    ...
    <div className="relative mx-auto max-w-7xl px-6 py-8 md:py-10 lg:px-8">
      ...
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="relative aspect-[4/3] lg:aspect-auto overflow-hidden rounded-t-xl lg:rounded-l-xl lg:rounded-tr-none bg-muted/20">
            <Image
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-transparent to-black/20 lg:bg-gradient-to-r lg:from-transparent lg:to-transparent" />
          </div>
