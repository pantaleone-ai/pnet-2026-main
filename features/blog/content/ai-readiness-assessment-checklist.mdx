...
Score each category from 1-5. Category weights are suggested defaults (see the scoring worksheet at the end) — adjust them to your org:
...
## Category 1: Data Infrastructure
...
3. **Automation Potential:** How much of your work is repetitive and rule-based?
   ...
   - 3: about a third to half of tasks are repetitive
   - 5: most tasks are repetitive and rule-based
