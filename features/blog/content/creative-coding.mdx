...
image: "https://img.pantaleone.net/blog-images/grid.webp"
created: "2025-02-08"
date: "2025-02-08"
...
The standard web has become a grid of predictable boxes. As builders, we should see the web not as a static document, but as a dynamic canvas. Libraries like **p5.js** and **Three.js** are the tools we can use to break free from the grid and create immersive, generative experiences.
...
![p5js output 1](https://img.pantaleone.net/blog-images/p5js1.png)
...
![p5js output 2](https://img.pantaleone.net/blog-images/p5js2.png)
