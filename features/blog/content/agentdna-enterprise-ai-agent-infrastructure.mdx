...
image: "https://img.pantaleone.net/agent-dna1.webp"
...
![AgentDNA platform overview showing the connection between build, manage, and secure components.](https://img.pantaleone.net/agent-dna2.webp)
...
![Diagram of the AgentDNA Registry, highlighting features like versioning, access control, and audit trails.](https://img.pantaleone.net/agent-dna3.webp)
...
![Illustration of the AgentDNA Security Gateway, showing policy enforcement and threat detection.](https://img.pantaleone.net/agent-dna4.webp)
...
![Flowchart showing the Agent Lifecycle Management from build and test to deploy and monitor.](https://img.pantaleone.net/agent-dna5.webp)
