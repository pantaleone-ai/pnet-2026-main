...
Claude Code's success is driven by the 512,000 lines of "harness" logic, not just the model. Invest heavily in the infrastructure that wraps the LLM. The model weights may be the moat, but the orchestration layer is the product.
