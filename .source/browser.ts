...
const browserCollections = {
  ...
  aiApps: create.doc("aiApps", {}),
  aiArt: create.doc("aiArt", {}),
  aiServices: create.doc("aiServices", {}),
  aiWorkflows: create.doc("aiWorkflows", {}),
