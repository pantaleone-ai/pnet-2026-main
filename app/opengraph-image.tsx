...
// Edge-rendered OG image, cached by the CDN after first fill (no ISR
// polling). NOTE: no `dynamic = "force-static"` here — it is incompatible
// with edge runtime. Origin cost is bounded by the force-cached font fetch.
